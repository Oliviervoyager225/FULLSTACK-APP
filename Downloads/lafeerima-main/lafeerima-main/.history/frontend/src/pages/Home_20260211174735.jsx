...
const fallbackNews = [
  {
    ...
    imageUrl: '/assets/feerima/news-1.png',
    linkUrl: '#',
  },
  {
    id: 'placeholder-2',
    ...
    imageUrl: '/assets/feerima/news-2.png',
    linkUrl: '#',
  },
  {
    id: 'placeholder-3',
    ...
    imageUrl: '/assets/feerima/news-3.png',
    linkUrl: '#',
  },
];
      ...
      <main>
          ...
          <div className="container welcome-grid">
            <div className="welcome-portrait">
              <img
                ...
                src="/assets/feerima/portrait.png"
                alt="Portrait"
              />
        ...
        <section className="info-grid container">
          <div className="contact-card">
            ...
            <img
              className="map-icon"
              src="/assets/feerima/map-pin.png"
              alt="Localisation"
            />
