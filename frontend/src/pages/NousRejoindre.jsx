...
export default function NousRejoindre() {
    ...
    // ex: /nous-rejoindre#offres-emploi
    useEffect(() => {
    ...
    return (
        <div style={{ fontFamily: "'Nunito', 'Segoe UI', sans-serif" }}>
            ...
            <main style={{ background: '#f7f8fa', minHeight: '100vh' }}>
                ...
                {/* ── Intro ── */}
                {/* ID : "pourquoi-nous-rejoindre" correspond au 1er item du sous-menu */}
                <section
                    id="pourquoi-nous-rejoindre"
                    style={{ maxWidth: '860px', margin: '0 auto', padding: '4rem 1.5rem 3rem', textAlign: 'center', scrollMarginTop: '80px' }}
                >
                    <p style={{ fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: ACCENT, marginBottom: '0.5rem' }}>
                        Engagement & Impact
                    </p>
                ...
                <section
                    id="offres-emploi"
                    style={{ maxWidth: '860px', margin: '0 auto', padding: '0 1.5rem 3.5rem', scrollMarginTop: '80px' }}
                >
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem', flexWrap: 'wrap', gap: '12px' }}>
                        <div>
                            <h2 style={{ fontSize: '1.25rem', fontWeight: 800, color: NAVY, margin: 0 }}>Offres d'emploi</h2>
