        ...
        <section className="info-section-fullwidth">
          <div className="container">
            ...
            <div className="news-panel-fullwidth">
              ...
              {/* Map Container - Interactive Google Maps + Lab Image */}
              <div className="map-container-fullwidth">
                <h3 className="news-title-fullwidth map-title">Localisation</h3>
                <div className="map-with-lab-wrapper">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3972.2280842486877!2d-4.029168!3d5.336367!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc1ecdb3c7e3d97%3A0x4e1e3b5e5e5e5e5e!2sPlateau%2C%20Abidjan%2C%20C%C3%B4te%20d'Ivoire!5e0!3m2!1sfr!2sus!4v1234567890123!5m2!1sfr!2sus"
                    width="100%"
                    height="450"
                    ...
                    title="Carte Abidjan Plateau"
                    className="google-map-iframe"
                  />

                  <div className="lab-image-container">
                    <img src="/assets/feerima/centre1.png" alt="Laboratoire de santé" />
                  </div>
                </div>
              </div>
