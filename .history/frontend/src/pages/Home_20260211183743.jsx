...
export default function Home() {
  ...
  const heroImages = ['/assets/feerima/hero.png'];
  ...
  return (
    <div className="home-page">
      ...
      <main>
        <section className="hero" style={{ backgroundImage: `linear-gradient(135deg, rgba(15, 160, 182, 0.5), rgba(173, 220, 233, 0.5)), url('${heroImages[heroIndex]}')` }}>
          <button 
            type="button" 
